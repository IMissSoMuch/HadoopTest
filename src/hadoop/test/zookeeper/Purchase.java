...
public class Purchase {
	...
	public static Map path() {
		...
		path.put("purchase", "data/purchase.csv");// 本地的数据文件
		path.put("input", HDFS + "/user/root/test/biz/purchase");// HDFS的目录
		path.put("output", HDFS + "/user/root/test/biz/purchase/output"); // 输出目录
		return path;
	}
