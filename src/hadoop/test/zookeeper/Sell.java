...
public class Sell{
	...
	public static class SellMapper extends Mapper <Object, Text, Text, IntWritable> {
...
//		job.setOutputFormatClass(TextOutputFormat.class);
	...
	public static Map path() {
		...
		path.put("sell", "data/sell.csv");// 本地的数据文件
		path.put("input", HDFS + "/user/root/test/biz/sell");// HDFS的目录
		path.put("output", HDFS + "/user/root/test/biz/sell/output"); // 输出目录
		return path;
	}
